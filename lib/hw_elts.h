...
/**
* Swap the shadow registers with their respective main registers.
* @param proc the processor in which to perform the swap.
*/
void swap_shadow_regs(proc_t *proc);

/**
* Swap the shadow flags with their respective main flags.
* @param proc the processor in which to perform the swap.
*/
